...
EXACT = {
    ...
    "Token kimliği gerekli.": "A token id is required.",
    "Token bulunamadı.": "Token not found.",
    "Token iptal edildi.": "Token revoked.",
    "Tüm oturumlar sonlandırıldı.": "All sessions revoked.",
    "Çıkış yapıldı.": "Signed out.",
    "Geçersiz rol.": "Invalid role.",
    "Güncellenecek alan yok.": "Nothing to update.",
    "Kendi hesabınızı değiştiremezsiniz.": "You cannot change your own account.",
    "Son aktif admin değiştirilemez.": "The last active admin cannot be changed.",
