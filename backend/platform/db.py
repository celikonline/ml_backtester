...
optimization_candidates = Table("optimization_candidates", metadata,
    Column("id", String(36), primary_key=True), Column("experiment_id", String(36), ForeignKey("experiments.id"), nullable=False), Column("candidate_key", String(64), nullable=False), Column("generation", Integer), Column("genome", JSON, nullable=False), Column("metrics", JSON, nullable=False), Column("fold_metrics", JSON, nullable=False, default=list), Column("fitness", Float, nullable=False), Column("pareto_rank", Integer), Column("dominance_count", Integer, nullable=False, default=0), Column("decision", String(40), nullable=False), Column("artifact_ref", Text), Column("created_at", String(40), nullable=False))
